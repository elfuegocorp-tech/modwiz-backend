...
//
// manas_session — one run of Manas Session ("Gunakan Manasmu"). Priced
// 2026-09-06 by Rheza's rule: tokens the session costs, times five, at 3648
// tokens per Soul. Worst case ≈2.400 tokens (two Sonnet calls: ~1.700 of
// system prompt, cached after the first run, plus story, facts and two JSON
// replies) → 12.020 / 3648 = 3,29 → rounded UP to the next whole Soul. If the
// prompts in api/agni-chakti-reading.js grow, this number is stale.
