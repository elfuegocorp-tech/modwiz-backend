 ...
 *  to sell.
 *
 *  Every amount here has to name a product that Play actually sells, because
 *  the app derives `souls_<amount>` from it: a stale amount asks Google for a
 *  product that no longer exists and the card paints "Segera" instead of a
 *  price. Master moved 120 -> 150 on 2026-09-10, when souls_120 was
 *  deactivated in favour of souls_150. */
const FALLBACK_PACKAGES = [
  { id: 'starter', title: 'Starter', souls: 20 },
  { id: 'explorer', title: 'Explorer', souls: 50 },
  { id: 'master', title: 'Master', souls: 150 },
